...
export const RAW_DATA_INTERNATIONAL: RawPlayerData[] = [
    ...
    { id: 'int-au-11', name: 'A. Haddin', age: 32, nationality: 'Australia', role: 'AR', batting: 65, bowling: 56, style: 'A', isForeign: true, prefPos: [6, 7, 8] },
    { id: 'int-au-12', name: 'Langer', age: 24, nationality: 'Australia', role: 'BL', batting: 22, bowling: 72, style: 'D', isForeign: true, prefPos: [8, 9, 10, 11] },
    { id: 'int-au-13', name: 'Parsh', age: 26, nationality: 'Australia', role: 'WK', batting: 76, bowling: 0, style: 'N', isForeign: true, pos: 'OP', prefPos: [1, 2, 3] },
    { id: 'int-au-14', name: 'Mausechate', age: 23, nationality: 'Australia', role: 'BT', batting: 69, bowling: 23, style: 'A', isForeign: true, prefPos: [3, 4, 5, 6, 7] },
    { id: 'int-au-15', name: 'Wade', age: 25, nationality: 'Australia', role: 'BL', batting: 25, bowling: 84, style: 'D', isForeign: true, prefPos: [8, 9, 10, 11] },
    { id: 'int-au-16', name: 'Lance', age: 26, nationality: 'Australia', role: 'BT', batting: 76, bowling: 0, style: 'N', isForeign: true, pos: 'OP', prefPos: [1, 2, 3] },
    { id: 'int-au-17', name: 'M.G. Glaxen', age: 28, nationality: 'Australia', role: 'AR', batting: 82, bowling: 65, style: 'A', isForeign: true, pos: 'OP', prefPos: [1, 2, 3, 4, 5, 6, 7] },
    { id: 'int-au-18', name: 'J. Harris', age: 22, nationality: 'Australia', role: 'AR', batting: 56, bowling: 45, style: 'N', isForeign: true, prefPos: [5, 6, 7, 8, 9] },
    { id: 'int-au-19', name: 'Lin', age: 23, nationality: 'Australia', role: 'BL', batting: 34, bowling: 68, style: 'N', isForeign: true, prefPos: [8, 9, 10, 11] },
    { id: 'int-au-20', name: 'Wilton', age: 27, nationality: 'Australia', role: 'AR', batting: 72, bowling: 64, style: 'N', isForeign: true, prefPos: [3, 4, 5] },
    
    { id: 'int-nz-6', name: 'Waller', age: 24, nationality: 'New Zealand', role: 'BL', batting: 23, bowling: 67, style: 'N', isForeign: true, prefPos: [8, 9, 10, 11] },
    { id: 'int-nz-7', name: 'B. Rington', age: 28, nationality: 'New Zealand', role: 'AR', batting: 45, bowling: 56, style: 'N', isForeign: true, prefPos: [6, 7, 8, 9, 10, 11] },
    { id: 'int-nz-8', name: 'Addams', age: 25, nationality: 'New Zealand', role: 'AR', batting: 55, bowling: 45, style: 'N', isForeign: true, prefPos: [5, 6, 7, 8, 9, 10, 11] },
    { id: 'int-nz-9', name: 'S. Warner', age: 26, nationality: 'New Zealand', role: 'BT', batting: 76, bowling: 33, style: 'A', isForeign: true, pos: 'OP', prefPos: [1, 2, 3] },
    { id: 'int-nz-10', name: 'Sprike', age: 22, nationality: 'New Zealand', role: 'WK', batting: 80, bowling: 0, style: 'A', isForeign: true, pos: 'OP', prefPos: [1, 2, 3] },
    
    { id: 'int-wi-4', name: 'Jordan', age: 24, nationality: 'West Indies', role: 'BL', batting: 23, bowling: 66, style: 'N', isForeign: true, prefPos: [8, 9, 10, 11] },
    { id: 'int-wi-5', name: 'N. Fill', age: 27, nationality: 'West Indies', role: 'SB', batting: 22, bowling: 68, style: 'N', isForeign: true, prefPos: [8, 9, 10, 11] },
    { id: 'int-wi-6', name: 'A. Chadwick', age: 23, nationality: 'West Indies', role: 'WK', batting: 73, bowling: 0, style: 'A', isForeign: true, pos: 'OP', prefPos: [1, 2, 3, 4] },
    
    { id: 'int-sl-3', name: 'Sriwardna', age: 26, nationality: 'Sri Lanka', role: 'BT', batting: 67, bowling: 0, style: 'D', isForeign: true, prefPos: [4, 5, 6] },
    { id: 'int-sl-4', name: 'C. Dhanushka', age: 28, nationality: 'Sri Lanka', role: 'AR', batting: 45, bowling: 66, style: 'D', isForeign: true, prefPos: [7, 8, 9] },
    
    { id: 'int-sa-2', name: 'James', age: 25, nationality: 'South Africa', role: 'AR', batting: 63, bowling: 66, style: 'A', isForeign: true, prefPos: [5, 6, 7, 8] },
    { id: 'int-sa-3', name: 'Aram', age: 29, nationality: 'South Africa', role: 'AR', batting: 45, bowling: 66, style: 'D', isForeign: true, prefPos: [6, 8] },
    
    { id: 'int-en-3', name: 'N. Colin', age: 24, nationality: 'England', role: 'AR', batting: 70, bowling: 61, style: 'N', isForeign: true, prefPos: [6, 8] },
    { id: 'int-en-4', name: 'D. Quentin', age: 22, nationality: 'England', role: 'BT', batting: 56, bowling: 23, style: 'N', isForeign: true, prefPos: [5, 8] },
];

export const RAW_DATA_SPINNERS: RawPlayerData[] = [
    { id: 'sb-1', name: 'Rahat', age: 24, nationality: 'Local', role: 'SB', batting: 12, bowling: 59, style: 'N', isForeign: false, prefPos: [8, 9, 10, 11], traits: ['ls'] },
    { id: 'sb-2', name: 'Abrar', age: 26, nationality: 'Local', role: 'SB', batting: 22, bowling: 62, style: 'D', isForeign: false, prefPos: [8, 9, 10, 11], traits: ['os'] },
    { id: 'sb-3', name: 'Anwar', age: 26, nationality: 'Local', role: 'SB', batting: 28, bowling: 81, style: 'N', isForeign: false, prefPos: [8, 9, 10, 11], traits: ['ls'] },
    { id: 'sb-4', name: 'Arshad', age: 28, nationality: 'Local', role: 'SB', batting: 22, bowling: 56, style: 'D', isForeign: false, prefPos: [8, 9, 10, 11], traits: ['ls'] },
    { id: 'sb-5', name: 'Mehrab', age: 22, nationality: 'Local', role: 'SB', batting: 16, bowling: 62, style: 'D', isForeign: false, prefPos: [8, 9, 10, 11], traits: ['lals'] },
    { id: 'sb-6', name: 'Bilal', age: 21, nationality: 'Local', role: 'SB', batting: 40, bowling: 78, style: 'N', isForeign: false, prefPos: [8, 9, 10, 11] },
    { id: 'sb-7', name: 'Adnan', age: 28, nationality: 'Local', role: 'SB', batting: 12, bowling: 56, style: 'D', isForeign: false, prefPos: [8, 9, 10, 11], traits: ['laos'] },
    { id: 'sb-8', name: 'Riaz', age: 22, nationality: 'Local', role: 'SB', batting: 11, bowling: 55, style: 'N', isForeign: false, prefPos: [8, 9, 10, 11], traits: ['lac'] },
    { id: 'sb-9', name: 'Amjad', age: 22, nationality: 'Local', role: 'SB', batting: 30, bowling: 69, style: 'D', isForeign: false, prefPos: [8, 9, 10, 11], traits: ['os'] },
    { id: 'sb-10', name: 'Rehan', age: 22, nationality: 'Local', role: 'SB', batting: 12, bowling: 61, style: 'N', isForeign: false, prefPos: [8, 9, 10, 11], traits: ['ls'] },
    { id: 'sb-11', name: 'N. Samad', age: 26, nationality: 'Local', role: 'SB', batting: 23, bowling: 55, style: 'D', isForeign: false, prefPos: [8, 9, 10, 11], traits: ['lac'] },
    { id: 'sb-12', name: 'M. Amjad', age: 30, nationality: 'Local', role: 'SB', batting: 45, bowling: 68, style: 'N', isForeign: false, prefPos: [8, 9, 10, 11], traits: ['ls'] },
    { id: 'sb-13', name: 'Asim', age: 22, nationality: 'Local', role: 'SB', batting: 23, bowling: 71, style: 'D', isForeign: false, prefPos: [8, 9, 10, 11], traits: ['os'] },
